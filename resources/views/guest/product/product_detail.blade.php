                                                    ...
                                                    <div class="wrapBlockInfo">
                                                        ...
                                                        <div class="pdPrice">
                                                            <p class="item price">
                                                                ...
                                                                <span id="pdPriceNumber">{{$product->product_price}}₫</span>
                                                            </p>
                                                            <p class="item comparePrice ">
                                                                <span class="pdLabelPrice">Giá thị trường: </span>
                                                                <span id="pdComparePriceNumber">{{$product->product_cost_price}}₫</span>
                                                            </p>
                                                            <p class="item compareSaleOff ">
                                                                <span class="pdLabelPrice">Tiết kiệm: </span>
                                                                <span id="pdCompareSalePrice">{{$product->product_compare_price}}₫ </span>
