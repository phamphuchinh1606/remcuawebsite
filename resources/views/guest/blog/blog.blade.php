                                        ...
                                        <div class="articlePostBody bg_w">
                                            <div class="postThumbIMG relative imageHover">
                                                ...
                                                <div class="createdInfo">
                                                    <ul class="notStyle">
                                                        ...
                                                        <li class="post"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> <span>Rèm cửa</span></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="postDetail">
                                                <div class="detail clearfix">
                                                    <h3>
                                                        <a href="{{route('blog.detail',['slug' => isset($blog->slug) ? $blog->slug : '1','id' => $blog->id])}}" title="{{$blog->blog_title}}">{{$blog->blog_title}}</a>
                                                    </h3>
                                                    <p>{{$blog->dot_blog_description}}</p>
                                                    <a href="{{route('blog.detail',['slug' => isset($blog->slug) ? $blog->slug : '1','id' => $blog->id ])}}" class="view" title="Xem thêm">Xem thêm <i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
